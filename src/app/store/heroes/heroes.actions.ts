...
const searchHeroes = createAction('[Heroes] set query', props<{query: string}>());
...
const updateHero = createAction('[Heroes] update Hero', props<{ hero: Hero}>());
const removeHero = createAction('[Heroes] set Hero to list', props<{ id: number }>());
